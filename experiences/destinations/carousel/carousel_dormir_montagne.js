/* carousel for dormir_montagne */
'use strict';

class CarouselMontagne {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/flanc_montagne/flanc_montagne_1.jpg' },
      { id: '2', src: '../../images/flanc_montagne/flanc_montagne_2.jpg' },
      { id: '3', src: '../../images/flanc_montagne/flanc_montagne_3.jpg' },
      { id: '4', src: '../../images/flanc_montagne/flanc_montagne_4.jpg' },
      { id: '5', src: '../../images/flanc_montagne/flanc_montagne_5.jpg' }
    ];
    this.items = [];
  ...
  updatePositions() {
    ...
    this.items.forEach((itm, i) => {
      ...
      if (diff === 0) {
        ...
        itm.style.transform = `translate(-50%, -50%) translateX(${spacing * 3}px) translateY(8px) scale(0.6)`;
        itm.style.zIndex = 5;
        itm.style.opacity = '0';
...
document.querySelectorAll('.carousel').forEach(el => {
  const carousel = new CarouselMontagne(el);
  carousel.mounted();
});
