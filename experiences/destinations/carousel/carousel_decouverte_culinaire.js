...
class CarouselDecouverteCulinaire {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/cuisine/cuisine_1.jpg' },
      { id: '2', src: '../../images/cuisine/cuisine_2.jpg' },
      { id: '3', src: '../../images/cuisine/cuisine_3.jpg' },
      { id: '4', src: '../../images/cuisine/cuisine_4.jpg' },
      { id: '5', src: '../../images/cuisine/cuisine_5.jpg' }
    ];
    this.items = [];
...
document.querySelectorAll('.carousel').forEach(el => {
  const carousel = new CarouselDecouverteCulinaire(el);
  carousel.mounted();
});
