...
class CarouselAvion {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/avion/avion_1.jpg' },
      { id: '2', src: '../../images/avion/avion_2.jpg' },
      { id: '3', src: '../../images/avion/avion_3.jpg' },
      { id: '4', src: '../../images/avion/avion_4.jpg' },
      { id: '5', src: '../../images/avion/avion_5.jpg' }
    ];
    this.items = [];
...
document.querySelectorAll('.carousel').forEach(el => {
  const carousel = new CarouselAvion(el);
  carousel.mounted();
});
