/* carousel for saut_parachute (reuses pattern) */
'use strict';
...
class CarouselSaut {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/parachute/parachute_1.jpg' },
      { id: '2', src: '../../images/parachute/parachute_2.jpg' },
      { id: '3', src: '../../images/parachute/parachute_3.jpg' },
      { id: '4', src: '../../images/parachute/parachute_4.jpg' },
      { id: '5', src: '../../images/parachute/parachute_5.jpg' }
    ];
    this.items = [];
...
document.querySelectorAll('.carousel').forEach(el => {
  const carousel = new CarouselSaut(el);
  carousel.mounted();
});
