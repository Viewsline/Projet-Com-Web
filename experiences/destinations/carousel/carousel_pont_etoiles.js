...
class CarouselSouffle {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/pont_etoiles/pont_etoiles_1.jpg' },
      { id: '2', src: '../../images/pont_etoiles/pont_etoiles_2.jpg' },
      { id: '3', src: '../../images/pont_etoiles/pont_etoiles_3.png' },
      { id: '4', src: '../../images/pont_etoiles/pont_etoiles_4.jpg' },
      { id: '5', src: '../../images/pont_etoiles/pont_etoiles_5.jpg' }
    ];
    this.items = [];
