...
class CarouselImmersionFerme {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/ferme/ferme_1.jpg' },
      { id: '2', src: '../../images/ferme/ferme_2.jpg' },
      { id: '3', src: '../../images/ferme/ferme_3.jpg' },
      { id: '4', src: '../../images/ferme/ferme_4.jpg' },
      { id: '5', src: '../../images/ferme/ferme_5.jpg' },
    ];
    this.items = [];
...
document.querySelectorAll('.carousel').forEach(el => {
  const carousel = new CarouselImmersionFerme(el);
  carousel.mounted();
});
