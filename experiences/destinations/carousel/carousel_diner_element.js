...
class CarouselSouffle {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/diner_elements/diner_elements_2.jpg' },
      { id: '2', src: '../../images/diner_elements/diner_elements_1.jpg' },
      { id: '3', src: '../../images/diner_elements/diner_elements_3.png' },
      { id: '4', src: '../../images/diner_elements/diner_elements_4.jpg' },
      { id: '5', src: '../../images/diner_elements/diner_elements_5.jpg' }
    ];
    this.items = [];
  ...
  setupCarousel() {
    ...
    this.carouselData.forEach((imgData, i) => {
      ...
      img.onload = () => console.log('Image loaded:', imgData.src);
      img.onerror = () => console.error('Image load error:', imgData.src);
...
document.querySelectorAll('.carousel').forEach(el => {
  const carousel = new CarouselSouffle(el);
  carousel.mounted();
});
