...
class CarouselSouffle {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/catacombes/catacombes_1.jpg' },
      { id: '2', src: '../../images/catacombes/catacombes_2.jpg' },
      { id: '3', src: '../../images/catacombes/catacombes_3.png' },
      { id: '4', src: '../../images/catacombes/catacombes_4.jpg' },
      { id: '5', src: '../../images/catacombes/catacombes_5.jpg' }
    ];
    this.items = [];
