...
class CarouselChateauVirtuel {
  constructor(el) {
    this.el = el;
    this.carouselData = [
      { id: '1', src: '../../images/chateau/chateau_1.jpg' },
      { id: '2', src: '../../images/chateau/chateau_2.jpg' },
      { id: '3', src: '../../images/chateau/chateau_3.jpg' },
      { id: '4', src: '../../images/chateau/chateau_4.jpg' },
      { id: '5', src: '../../images/chateau/chateau_5.jpg' }
    ];
    this.items = [];
...
document.querySelectorAll('.carousel').forEach(el => {
  const carousel = new CarouselChateauVirtuel(el);
  carousel.mounted();
});
